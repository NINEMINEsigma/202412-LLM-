...
CurrentSampleTestCore:      List[SampleTestCore]                    = {}
def GetSampleTestCore():
    global CurrentSampleTestCore
    if len(CurrentSampleTestCore) == 0:
        return SampleTestCore()
    return CurrentSampleTestCore
